#!/bin/bash
# Full native HF LOFT-128K baseline: no KVPress hooks or compression.
#SBATCH --job-name=direct-loft128-q35-gptq
...
"${BASE_DIR}/miniconda3/envs/kvpress/bin/python" direct_baseline/run_baseline.py \
  --config direct_baseline/configs/qwen35_27b_gptq_int4_loft128k.yaml
