#!/bin/bash
# Download and validate the 64K Synthetic-KV dataset.
set -euo pipefail
...
"${PRAJNA_PYTHON}" "${PRAJNA_REPO}/evaluation/benchmarks/synthetickv64k/prepare_dataset.py"

export HF_HUB_OFFLINE=true
export HF_DATASETS_OFFLINE=true
"${PRAJNA_PYTHON}" "${PRAJNA_REPO}/evaluation/benchmarks/synthetickv64k/prepare_dataset.py" --offline-check
